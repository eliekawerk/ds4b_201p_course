...
def process_leads_tags(leads_df, tags_df):
    """Processing Pipeline that combines leads and tags data frames and prepares 
    for machine learning.

    Args:
        leads_df (DataFrame): els.db_read_els_data()
        tags_df (DataFrame): els.db_read_raw_ets_table('Tags')
